...
@Deprecated('${_DeprecatedTca.reducerEffectEnglish}\n${_DeprecatedTca.reducerEffectKorean}')
typedef ReducerEffect<State, Action> = ({TaskEither<Action, Object>? effect, State newState});
...
@Deprecated('${_DeprecatedTca.blocArchTcaEnglish}\n${_DeprecatedTca.blocArchTcaKorean}')
abstract class BlocArchTca<Action, State, Environment> extends Bloc<Action, State> {
  ...
  /// 주입할 때 유용합니다.
  @Deprecated('${_DeprecatedTca.tcaPerformEffectEnglish}\n${_DeprecatedTca.tcaPerformEffectKorean}')
  @protected
  ...
  @Deprecated('${_DeprecatedTca.tcaReducerEnglish}\n${_DeprecatedTca.tcaReducerKorean}')
...
sealed class _DeprecatedTca {
  const _DeprecatedTca._();

  // blocArchTca
  static const String blocArchTcaEnglish =
      '`BlocArchTca` will be removed in version `2.0.0`. Use `TcaBloc` or `TcaCoreMixin` instead.';
  static const String blocArchTcaKorean =
      '`BlocArchTca`는 `2.0.0` 버전에서 제거됩니다. 대신 `TcaBloc` 또는 `TcaCoreMixin`를 사용하세요.';

  // ReducerEffect
  static const String reducerEffectEnglish = '`ReducerEffect` will be removed in version `2.0.0`.';
  static const String reducerEffectKorean = '`ReducerEffect`는 `2.0.0` 버전에서 제거됩니다.';

  // tcaPerform
  static const String tcaPerformEffectEnglish =
      '`tcaPerform` will be removed in version `2.0.0`.Use `effectBuilder` instead.';

  static const String tcaPerformEffectKorean =
      '`tcaPerform`는 `2.0.0` 버전에서 제거됩니다. 대신 `effectBuilder`를 사용하세요.';

  // tcaReducer
  static const String tcaReducerEnglish =
      '`tcaReducer` will be removed in version `2.0.0`.Use `reduce` instead.';
  static const String tcaReducerKorean = '`tcaReducer`는 `2.0.0` 버전에서 제거됩니다. 대신 `reduce`를 사용하세요.';
}